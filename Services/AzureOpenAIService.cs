    ...
    public class AzureOpenAIService : IAzureOpenAIService
    {
        ...
        public async Task<string> SummarizeTranscriptAsync(string transcript)
        {
            try
            {
                ...
                var systemPrompt = @"You are an expert podcast summarizer specializing in creating concise, engaging audio summaries. Your summaries are designed to be read aloud and should sound natural when spoken.

Your task is to distill podcast content into exactly 5 minutes worth of spoken content (approximately 750 words at 150 words per minute).
...
Your summary should be ready to be converted directly to speech without any further editing.";
                ...
                var userPrompt = $@"Please summarize the following podcast transcript into exactly 5 minutes of spoken content (approximately 750 words). Ensure all important points are captured while staying within the word limit.
